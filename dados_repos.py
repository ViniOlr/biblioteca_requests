...
# Criando arquivo do meu repositório pessoal
vini_rep = DadosRepositorios('ViniOlr')
ling_mais_usadas_vini = vini_rep.cria_df_linguagens()

ling_mais_usadas_vini.to_csv('dados/linguagens_vini.csv')